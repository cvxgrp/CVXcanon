...
class LinOp(_object):
    ...
    def set_dense_data(self, matrix, rows, cols):
        return _CVXcanon.LinOp_set_dense_data(self, matrix, rows, cols)

    def set_sparse_data(self, data, data_len, row_idxs, rows_len, col_idxs, cols_len, rows, cols):
        return _CVXcanon.LinOp_set_sparse_data(self, data, data_len, row_idxs, rows_len, col_idxs, cols_len, rows, cols)
...
class ProblemData(_object):
    ...
    def getV(self, values, num_values):
        return _CVXcanon.ProblemData_getV(self, values, num_values)

    def getI(self, values, num_values):
        return _CVXcanon.ProblemData_getI(self, values, num_values)

    def getJ(self, values, num_values):
        return _CVXcanon.ProblemData_getJ(self, values, num_values)

    def getConstVec(self, values, num_values):
        return _CVXcanon.ProblemData_getConstVec(self, values, num_values)
