...
```
Note that the use of CVXPY's Parameters is currently disabled in CVXCanon. One can expect a 2 - 10x  speed-up over the original CVXPY implementation on most other problems.
