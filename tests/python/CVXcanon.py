...
class ProblemData(_object):
    ...
    __swig_setmethods__["data"] = _CVXcanon.ProblemData_data_set
    __swig_getmethods__["data"] = _CVXcanon.ProblemData_data_get
    if _newclass:
        data = _swig_property(_CVXcanon.ProblemData_data_get, _CVXcanon.ProblemData_data_set)
...
class LinOp(_object):
    ...
    __swig_setmethods__["data"] = _CVXcanon.LinOp_data_set
    __swig_getmethods__["data"] = _CVXcanon.LinOp_data_get
    if _newclass:
        data = _swig_property(_CVXcanon.LinOp_data_get, _CVXcanon.LinOp_data_set)
    ...
    def hasConstantType(self):
        return _CVXcanon.LinOp_hasConstantType(self)
...
def build_matrix(constraints, id_to_col):
    return _CVXcanon.build_matrix(constraints, id_to_col)
